            ...
            <header className="bg-dark-card/80 backdrop-blur-sm sticky top-0 z-50 border-b border-gray-700">
                <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
                    ...
                    <div className="hidden md:flex items-center space-x-4">
                        ...
                        <a href="https://wa.me/3105431968" className="flex items-center space-x-2 bg-[#25D366] text-white px-5 py-2.5 rounded-lg font-semibold hover:bg-[#20b85a] transition-transform hover:scale-105" aria-label="Contactar por WhatsApp">
                            <FaWhatsapp size={20} />
                            <span>WhatsApp</span>
                        </a>
                        ...
                        <div className="bg-dark-card rounded-lg shadow-lg p-8 md:p-10 border border-gray-700 max-w-2xl mx-auto">
                            ...
                            <div className="flex flex-col md:flex-row justify-center space-y-4 md:space-y-0 md:space-x-8 mb-6">
                                <div className="bg-gray-800 p-4 rounded-lg flex-1">
                                    ...
                                    <p className="text-white">**3106011864**</p>
                                </div>
                                <div className="bg-gray-800 p-4 rounded-lg flex-1">
                            ...
                            <a href="https://wa.me/3105431968" className="bg-[#25D366] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#20b85a] transition-colors flex items-center justify-center space-x-2 w-full md:w-auto mx-auto shadow-lg">
                                <FaWhatsapp size={20} />
